...
int __init mx25_clocks_init(void)
{
	...
	clk_register_clkdev(clk[per10], "per", "imx27-pwm.0");
	clk_register_clkdev(clk[pwm1_ipg], "ipg", "imx27-pwm.1");
	clk_register_clkdev(clk[per10], "per", "imx27-pwm.1");
	clk_register_clkdev(clk[pwm1_ipg], "ipg", "imx27-pwm.2");
	clk_register_clkdev(clk[per10], "per", "imx27-pwm.2");
	clk_register_clkdev(clk[pwm1_ipg], "ipg", "imx27-pwm.3");
	clk_register_clkdev(clk[per10], "per", "imx27-pwm.3");
