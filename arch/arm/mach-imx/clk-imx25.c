...
static int __init __mx25_clocks_init(unsigned long osc_rate)
{
	...
	clk_prepare_enable(clk[iim_ipg]);
...
int __init mx25_clocks_init(void)
{
	...
	clk_register_clkdev(clk[pwm1_ipg], "ipg", "imx27-pwm.0");
	clk_register_clkdev(clk[pwm_ipg_per], "per", "imx27-pwm.0");
	clk_register_clkdev(clk[pwm1_ipg], "ipg", "imx27-pwm.1");
	clk_register_clkdev(clk[pwm_ipg_per], "per", "imx27-pwm.1");
	clk_register_clkdev(clk[pwm1_ipg], "ipg", "imx27-pwm.2");
	clk_register_clkdev(clk[pwm_ipg_per], "per", "imx27-pwm.2");
	clk_register_clkdev(clk[pwm1_ipg], "ipg", "imx27-pwm.3");
	clk_register_clkdev(clk[pwm_ipg_per], "per", "imx27-pwm.3");
	clk_register_clkdev(clk[kpp_ipg], NULL, "imx-keypad");
	clk_register_clkdev(clk[tsc_ipg], NULL, "imx_adc");
