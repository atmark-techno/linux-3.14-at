...
#if defined(CONFIG_IOMUX_MX25_GPIO_SION)
...
#define MX25_PAD_LD8__UART4_RXD		IOMUX_PAD(0x2e0, 0x0e8, 0x12, 0x570, 0, NO_PAD_CTRL)
...
#define MX25_PAD_LD9__UART4_TXD		IOMUX_PAD(0x2e4, 0x0ec, 0x12, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_LD10__UART4_RTS	IOMUX_PAD(0x2e8, 0x0f0, 0x12, 0x56c, 0, NO_PAD_CTRL)
...
#define MX25_PAD_LD11__UART4_CTS	IOMUX_PAD(0x2ec, 0x0f4, 0x12, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_LD12__CSPI2_MOSI	IOMUX_PAD(0x2f0, 0x0f8, 0x12, 0x4a0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_LD13__CSPI2_MISO	IOMUX_PAD(0x2f4, 0x0fc, 0x12, 0x49c, 0, NO_PAD_CTRL)
...
#define MX25_PAD_LD14__CSPI2_SCLK	IOMUX_PAD(0x2f8, 0x100, 0x12, 0x494, 0, NO_PAD_CTRL)
...
#define MX25_PAD_LD15__CSPI2_RDY	IOMUX_PAD(0x2fc, 0x104, 0x12, 0x498, 0, NO_PAD_CTRL)
...
#define MX25_PAD_HSYNC__I2C3_CLK	IOMUX_PAD(0x300, 0x108, 0x12, 0x524, 0, NO_PAD_CTRL)
...
#define MX25_PAD_VSYNC__I2C3_DAT	IOMUX_PAD(0x304, 0x10c, 0x12, 0x528, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_D2__CSPI3_MOSI	IOMUX_PAD(0x318, 0x120, 0x17, 0x4b8, 1, NO_PAD_CTRL)

#define MX25_PAD_CSI_D3__CSI_D3		IOMUX_PAD(0x31c, 0x124, 0x10, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D3__UART5_TXD_MUX	IOMUX_PAD(0x31c, 0x124, 0x11, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_D4__CSPI3_SCLK	IOMUX_PAD(0x320, 0x128, 0x17, 0x4ac, 1, NO_PAD_CTRL)

#define MX25_PAD_CSI_D5__CSI_D5		IOMUX_PAD(0x324, 0x12c, 0x10, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D5__UART5_CTS	IOMUX_PAD(0x324, 0x12c, 0x11, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D5__GPIO_1_30	IOMUX_PAD(0x324, 0x12c, 0x15, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D5__CSPI3_RDY	IOMUX_PAD(0x324, 0x12c, 0x17, 0x4b0, 1, NO_PAD_CTRL)

#define MX25_PAD_CSI_D6__CSI_D6		IOMUX_PAD(0x328, 0x130, 0x10, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D6__SD2_CMD	IOMUX_PAD(0x328, 0x130, 0x12, 0x4e0, 1, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_D7__SD2_CLK	IOMUX_PAD(0x32c, 0x134, 0x12, 0x4dc, 1, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_D8__AUD6_RXC	IOMUX_PAD(0x330, 0x138, 0x12, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_D9__AUD6_RXFS	IOMUX_PAD(0x334, 0x13c, 0x12, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_MCLK__AUD6_TXD	IOMUX_PAD(0x338, 0x140, 0x11, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_MCLK__SD2_DATA0	IOMUX_PAD(0x338, 0x140, 0x12, 0x4e4, 1, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_VSYNC__AUD6_RXD	IOMUX_PAD(0x33c, 0x144, 0x11, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_VSYNC__SD2_DATA1	IOMUX_PAD(0x33c, 0x144, 0x12, 0x4e8, 1, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_HSYNC__AUD6_TXC	IOMUX_PAD(0x340, 0x148, 0x11, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_HSYNC__SD2_DATA2	IOMUX_PAD(0x340, 0x148, 0x12, 0x4ec, 1, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_PIXCLK__AUD6_TXFS	IOMUX_PAD(0x344, 0x14c, 0x11, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_PIXCLK__SD2_DATA3	IOMUX_PAD(0x344, 0x14c, 0x12, 0x4f0, 1, NO_PAD_CTRL)
...
#define MX25_PAD_CSPI1_MOSI__UART3_RXD_MUX	IOMUX_PAD(0x350, 0x158, 0x12, 0x568, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CSPI1_MISO__UART3_TXD_MUX	IOMUX_PAD(0x354, 0x15c, 0x12, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CSPI1_SS0__PWM2_PWMO	IOMUX_PAD(0x358, 0x160, 0x12, 0, 0, NO_PAD_CTRL)

#define MX25_PAD_CSPI1_SS1__CSPI1_SS1	IOMUX_PAD(0x35c, 0x164, 0x10, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSPI1_SS1__UART3_RTS	IOMUX_PAD(0x35c, 0x164, 0x12, 0x564, 0, NO_PAD_CTRL)
#define MX25_PAD_CSPI1_SS1__GPIO_1_17	IOMUX_PAD(0x35c, 0x164, 0x15, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSPI1_SS1__I2C3_DAT	IOMUX_PAD(0x35c, 0x164, 0x11, 0x528, 1, NO_PAD_CTRL)

#define MX25_PAD_CSPI1_SCLK__CSPI1_SCLK	IOMUX_PAD(0x360, 0x168, 0x10, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSPI1_SCLK__UART3_CTS	IOMUX_PAD(0x360, 0x168, 0x12, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_UART1_RXD__UART2_DTR	IOMUX_PAD(0x368, 0x170, 0x13, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_UART1_TXD__UART2_DSR	IOMUX_PAD(0x36c, 0x174, 0x13, 0, 0, PAD_CTL_PUS_100K_UP)
...
#define MX25_PAD_UART1_RTS__UART2_DCD	IOMUX_PAD(0x370, 0x178, 0x13, 0, 0, PAD_CTL_PUS_100K_UP)
...
#define MX25_PAD_UART1_CTS__UART2_RI	IOMUX_PAD(0x374, 0x17c, 0x13, 0, 0, PAD_CTL_PUS_100K_UP)
...
#define MX25_PAD_KPP_ROW0__UART3_RXD	IOMUX_PAD(0x3a0, 0x1a8, 0x11, 0x568, 1, NO_PAD_CTRL)
...
#define MX25_PAD_KPP_ROW2__UART3_RTS	IOMUX_PAD(0x3a8, 0x1b0, 0x11, 0x564, 1, NO_PAD_CTRL)
#define MX25_PAD_KPP_ROW2__AUD5_RXC	IOMUX_PAD(0x3a8, 0x1b0, 0x12, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_KPP_ROW3__UART3_CTS	IOMUX_PAD(0x3ac, 0x1b4, 0x11, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_KPP_ROW3__AUD5_RXFS	IOMUX_PAD(0x3ac, 0x1b4, 0x12, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_KPP_COL2__UART4_RTS	IOMUX_PAD(0x3b8, 0x1c0, 0x11, 0x56c, 1, NO_PAD_CTRL)
...
#define MX25_PAD_GPIO_A__I2C3_CLK	IOMUX_PAD(0x3f0, 0x1f4, 0x14, 0x524, 1, NO_PAD_CTRL)
#define MX25_PAD_GPIO_A__PWM2_PWMO	IOMUX_PAD(0x3f0, 0x1f4, 0x11, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_GPIO_B__I2C3_DAT	IOMUX_PAD(0x3f4, 0x1f8, 0x14, 0x528, 2, NO_PAD_CTRL)
#define MX25_PAD_GPIO_B__PWM3_PWMO	IOMUX_PAD(0x3f4, 0x1f8, 0x11, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_GPIO_C__I2C2_CLK	IOMUX_PAD(0x3f8, 0x1fc, 0x12, 0x51c, 1, NO_PAD_CTRL)
#define MX25_PAD_GPIO_C__PWM4_PWMO	IOMUX_PAD(0x3f8, 0x1fc, 0x11, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_GPIO_D__I2C2_DAT	IOMUX_PAD(0x3fc, 0x200, 0x12, 0x520, 1, NO_PAD_CTRL)
...
#define MX25_PAD_GPIO_E__I2C3_CLK	IOMUX_PAD(0x400, 0x204, 0x11, 0x524, 2, NO_PAD_CTRL)
...
#else /* defined(CONFIG_IOMUX_MX25_GPIO_SION) */

/* Enable SION bit and pullup DATA4-7 pads as GPIO or SDHC-2 card
 * interrupt wouldn't occur.  It strange behaviour must be the
 * errarum. But it isn't in a official erratum list. We need to disable
 * SION bit in pad configuration as workaround.
 */
...
#define MX25_PAD_CSI_D2__CSPI3_MOSI	IOMUX_PAD(0x318, 0x120, 0x07, 0x4b8, 1, NO_PAD_CTRL)

#define MX25_PAD_CSI_D3__CSI_D3		IOMUX_PAD(0x31c, 0x124, 0x00, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D3__UART5_TXD_MUX	IOMUX_PAD(0x31c, 0x124, 0x01, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D3__GPIO_1_28	IOMUX_PAD(0x31c, 0x124, 0x05, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D3__CSPI3_MISO	IOMUX_PAD(0x31c, 0x124, 0x07, 0x4b4, 1, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_D4__CSPI3_SCLK	IOMUX_PAD(0x320, 0x128, 0x07, 0x4ac, 1, NO_PAD_CTRL)

#define MX25_PAD_CSI_D5__CSI_D5		IOMUX_PAD(0x324, 0x12c, 0x00, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D5__UART5_CTS	IOMUX_PAD(0x324, 0x12c, 0x01, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D5__GPIO_1_30	IOMUX_PAD(0x324, 0x12c, 0x05, 0, 0, NO_PAD_CTRL)
#define MX25_PAD_CSI_D5__CSPI3_RDY	IOMUX_PAD(0x324, 0x12c, 0x07, 0x4b0, 1, NO_PAD_CTRL)
...
#endif /* defined(CONFIG_IOMUX_MX25_GPIO_SION) */
